...
extension UIViewController
{
    ...
    public func setColors() -> () {
        if(navigationController != nil)
        {
            ...
            navigationController!.navigationBar.titleTextAttributes = [kCTForegroundColorAttributeName: TLColors.mainAppOppositeColor()] as [NSAttributedStringKey : Any]
    ...
    public func setNavigationBarColors(_ navigationBar:UINavigationBar) -> () {
        ...
        navigationBar.titleTextAttributes = [kCTForegroundColorAttributeName: TLColors.mainAppOppositeColor()] as [NSAttributedStringKey : Any]
        navigationBar.barTintColor = TLColors.mainAppColor()
