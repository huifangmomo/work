...
struct TransactionDetailsViewModel {
    ...
    public let shortFormatter = EtherNumberFormatter.short
    public let fullFormatter = EtherNumberFormatter.full
    public let currencyRate: CurrencyRate?
    public var monetaryAmountViewModel: MonetaryAmountViewModel {
...
//        formatter.dateStyle = .long
    ...
    var subTitle: String {
        ...
        case .incoming:
            return String(format: "%@:%@...%@","From",String(transactionViewModel.transactionFrom.prefix(10)), String(transactionViewModel.transactionFrom.suffix(10)))
        case .outgoing:
            return String(format: "%@:%@...%@","To",String(transactionViewModel.transactionTo.prefix(10)), String(transactionViewModel.transactionTo.suffix(10)))
        }
    }
