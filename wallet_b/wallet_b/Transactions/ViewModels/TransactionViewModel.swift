...
struct TransactionViewModel {
    ...
    public let balanceFormatter = EtherNumberFormatter.balance
    ...
    var amountTextColor: UIColor {
        switch direction {
        case .incoming: return UIColor.green
        case .outgoing: return UIColor.red
        }
    }
    ...
    var statusImage: UIImage? {
        ...
        case .error, .unknown, .failed, .deleted:
            return R.image.bg_fail()
        case .completed:
            switch direction {
            case .incoming:
                return R.image.bg_into()
            case .outgoing:
                return R.image.bg_turnout()
            }
        case .pending:
            return R.image.bg_operation()
        default:
            return R.image.bg_fail()
        }
    }
